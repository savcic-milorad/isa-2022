...
/// <summary>
/// Performs one of three checks, based on the authorize attribute setup on the command/query, whether user is authorized, whether user is in role or whether user conforms to policy.
